...
public class OWL {
	...
	public static OWLDataIntersectionOf and(OWLDataRange... descriptions) {
		return factory.getOWLDataIntersectionOf( set( descriptions ) );
	}

	public static OWLDataIntersectionOf and(Set<? extends OWLDataRange> descriptions) {
	...
	public static OWLEquivalentDataPropertiesAxiom equivalentProperties(OWLDataPropertyExpression p1,
			OWLDataPropertyExpression p2) {
		return factory.getOWLEquivalentDataPropertiesAxiom( set( p1, p2 ) );
	}

	public static OWLEquivalentDataPropertiesAxiom equivalentProperties(
	...
	public static OWLDataComplementOf not(OWLDataRange description) {
	...
	public static OWLDataUnionOf or(OWLDataRange... descriptions) {
		return factory.getOWLDataUnionOf( set( descriptions ) );
	}

	public static OWLDataUnionOf or(Set<? extends OWLDataRange> descriptions) {
